...
| container\_group\_log\_metadata | additional log metadata | `map(string)` | n/a | yes |
...
| container\_service\_image | docker image to deploy | `string` | `"alpine"` | no |
| container\_service\_name | name of the service you want to deploy | `string` | `"test"` | no |
