...
| container\_group\_log\_analytics | extended logging configuration 1 = log\_type, 2 workspace\_id, 3 = workspace\_key | `list(string)` | `null` | no |
| container\_group\_log\_analytics\_enabled | helper variable for conditional diagnostics block | `bool` | `false` | no |
...
| container\_group\_network\_profile | Azure Network profile ID | `string` | `null` | no |
...
| container\_liveness\_probe\_enabled | helper variable for conditional liveness block | `bool` | `false` | no |
| container\_lp\_exec | liveness probe exec command | `list(string)` | `null` | no |
...
| container\_readiness\_probe\_enabled | helper variable for conditional readiness block | `bool` | `false` | no |
...
| container\_rp\_exec | readiness probe exec command | `list(string)` | `null` | no |
